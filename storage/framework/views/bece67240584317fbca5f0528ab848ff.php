                    ...
                    <div class="shadow-md dark:bg-gray-800 sm:rounded-lg">
                        <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                            ...
                            <div class="w-full gap-4 md:w-1/2 flex justify-between">
                                <form class="flex items-center" action="<?php echo e(route('project.index')); ?>" method="GET" >
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td scope="row" class="flex items-center px-4 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="w-10 h-10 rounded-full" src="<?php echo e(asset('/storage/project/'.$data->pro_image)); ?>" alt="<?php echo e($data->pro_title); ?>">  
                        </td>
                        <td class="px-6 py-4">
                            <?php echo e($data->pro_title); ?>

                        </td>
                        <td class="px-6 py-4">
                            <?php echo e($data->pro_category); ?>

                        </td>
                        <td class="px-6 py-4">
                            <?php echo e($data->techstack()->get()->implode('tech_name' , ',')); ?>

                        </td>
                        <td class="px-6 py-4">
                            <?php echo e(Str::limit($data->pro_description,50)); ?>

                        </td>
                        <td class="px-2 py-4 ">
                            

                            <form id="delete-form-<?php echo e($data->pro_slug); ?>" action="<?php echo e(route('project.destroy', $data->pro_slug)); ?>" method="POST" style="display: none;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                            </form>
                            <a  href="<?php echo e(route('project.edit', $data->pro_slug)); ?>" type="button"  class="font-medium me-3 text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                            <button type="button" onclick="confirmDelete('<?php echo e($data->pro_slug); ?>')" class="font-medium text-red-600 dark:text-blue-500 hover:underline">
                                Delete
                            </button>
                        </td>
                    </tr>
...
<?php endif; ?>    <?php /**PATH D:\~Belajar\Backup\Belajar-BrezeREDESIGN\resources\views/layouts/admin-project/table.blade.php ENDPATH**/ ?>