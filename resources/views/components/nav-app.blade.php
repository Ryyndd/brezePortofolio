<header>
    ...
    {{-- <nav id="onScrol-hide" class="fixed top-0 z-50 w-full backdrop-blur-md backdrop-opacity-70 backdrop-brightness-20 mix-blend-screen dark:bg-black-50"> --}}
        ...
        <ul class="flex flex-col  martian-mono font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row   md:mt-0 md:border-0 dark:border-gray-700">
            ...
            <li>
            <a href="{{ route('about.page') }}" class="block py-2 px-3 md:p-0 text-gray-900 hover:underline">About</a>
            </li>
            <li>
            <a href="{{ route('project.page')}}" class="block py-2 px-3 md:p-0 text-gray-900 hover:underline">Project</a>
            </li>
            <li>
