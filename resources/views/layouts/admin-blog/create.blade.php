            ...
            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data"> 
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="blog_title" id="blog_title" value="{{ old('blog_title') }}" class="@error('blog_title') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="input title" required>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div id="editor" class="border border-gray-300 rounded-lg p-2">
                            <p>{!! old('blog_content') !!}</p>
                        </div>
                        <!-- Input tersembunyi untuk menyimpan data blog_content -->
                    ...
                    <div class="sm:col-span-2 mt-20">
                        ...
                        <select id="blog_status" name="blog_status" class="@error('blog_status') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
