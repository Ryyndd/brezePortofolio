            ...
            <form action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data"> 
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="pro_title" id="pro_title" value="{{ old('pro_title') }}" class="@error('pro_title') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="input title" required>
                    </div>
                    @error('pro_title')
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="form-group w-full">
                            ...
                            <select id="tech" name="tech_ids[]" class=" selectMultiple bg-gray-50 border py-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" multiple>
                                ...
                                <option value="{{ $tech->id }}">{{ ucfirst($tech->tech_name) }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="sm:col-span-2">
                        <div class="flex gap-4">
                            <div class="flex-1">
                                ...
                                <input type="text" name="pro_source" id="pro_source" value="{{ old('pro_source') }}" class="@error('pro_source') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="input link">
                            </div>
                            <div class="flex-1">
                                <label for="pro_title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Preview</label>
                                <input type="text" name="pro_preview" id="pro_preview" value="{{ old('pro_preview') }}" class="@error('pro_preview') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="input link">
                            </div>
                        </div>
                        @error('pro_source')
                        <div class="alert alert-danger mt-2">
